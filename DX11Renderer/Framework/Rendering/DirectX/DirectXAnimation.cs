...
{
    public class DirectXAnimation : IAnimation
    {
        ...
        /// <summary>
        /// Initializes a new DirectXAnimation class.
        /// </summary>
        /// <param name="spriteSheet">The SpriteSheet.</param>
        /// <param name="keyframe">The first Keyframe.</param>
        public DirectXAnimation(ISpriteSheet spriteSheet, Keyframe keyframe)
        {
            if (spriteSheet.GetType() != typeof (DirectXSpriteSheet))
                throw new ArgumentException("DirectXAnimation expects a DirectXTexture as resource");
        ...
        public DirectXAnimation(ISpriteSheet spriteSheet, params Keyframe[] keyframes)
        {
            if (spriteSheet.GetType() != typeof (DirectXSpriteSheet))
                throw new ArgumentException("DirectXAnimation expects a DirectXTexture as resource");
