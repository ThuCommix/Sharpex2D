...
namespace Sharpex2D.Framework.Rendering
{
    ...
    public struct Color
    {
        ...
        {
            var raw = stringColor.Replace("{", "").Replace("}", "").Trim().Split(':');
            return new Color(Convert.ToInt32(raw[1]), Convert.ToInt32(raw[3]), Convert.ToInt32(raw[5]), Convert.ToInt32(raw[7]));
        }

        /// <summary>
        /// Converts SharpexColor to Win32Color.
        /// </summary>
        /// <returns>Win32Color</returns>
        public System.Drawing.Color ToWin32Color()
        {
