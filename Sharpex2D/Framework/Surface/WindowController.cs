...
namespace Sharpex2D.Framework.Surface
{
    ...
    public class WindowController : ISurfaceControl
    {
        ...
        {
            MethodInvoker br = delegate { _surface.Icon = icon; };
            _surface.Invoke(br);
        }
        ...
        {
            FreeWindow();
            MethodInvoker br = delegate { _surface.ClientSize = new Size(width, height); };
            _surface.Invoke(br);
            FixWindow();
        }
        ...
        {
            MethodInvoker br = delegate { _surface.Location = new Point(x, y); };
            _surface.Invoke(br);
        }
        ...
        {
            Vector2 size = null;
            MethodInvoker br = delegate { size = new Vector2(_surface.Location.X, _surface.Location.Y); };
            _surface.Invoke(br);
            return size;
        }
        ...
        {
            MethodInvoker br = delegate { Cursor.Current = new Cursor(iconPath); };
            _surface.Invoke(br);
        }

        /// <summary>
        ///     Indicating whether the surface is active.
        /// </summary>
        ...
        /// <summary>
        ///     Called, if the surface is deactivated.
        /// </summary>
        /// <param name="sender">The Sender.</param>
        /// <param name="e">The EventArgs.</param>
        ...
        /// <summary>
        ///     Called, if the surface is activated.
        /// </summary>
        /// <param name="sender">The Sender.</param>
        /// <param name="e">The EventArgs.</param>
